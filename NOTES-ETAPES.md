# Notes par etape — reponses aux questions pedagogiques

Ce document conserve les reponses aux questions posees a chaque etape
du sujet (etapes 1 a 11). Pour l'analyse architecturale transversale
(MVC, DTO, Repository, SOLID...), voir `ARCHITECTURE.md`.
